    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-white to-gray-50 p-8">
      <div className="z-10 max-w-4xl w-full text-center space-y-8">
        ...
        <div className="pt-4">
          <Link
            href="/auth/signin"
            className="inline-flex items-center justify-center gap-3 rounded-md bg-[#0A66C2] px-8 py-4 text-base font-semibold text-white shadow-lg hover:bg-[#004182] focus:outline-none focus:ring-2 focus:ring-linkedin-500 focus:ring-offset-2 transition-all"
          >
            <svg
